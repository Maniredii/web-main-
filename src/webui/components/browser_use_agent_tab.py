...
# from webui.webui_manager import WebuiManager  # Remove this import to avoid circular import
...
def _get_config_value(
        webui_manager: Any, # Changed from WebuiManager to Any to avoid circular import
...
def _format_agent_output(model_output: Any) -> str: # Changed from AgentOutput to Any
...
async def _handle_new_step(
        webui_manager: Any, # Changed from WebuiManager to Any to avoid circular import
        state: BrowserState, output: Any, step_num: int # Changed from AgentOutput to Any
):
...
def _handle_done(webui_manager: Any, # Changed from WebuiManager to Any to avoid circular import
...
async def handle_stop(webui_manager: Any): # Changed from WebuiManager to Any to avoid circular import
...
async def handle_pause_resume(webui_manager: Any): # Changed from WebuiManager to Any to avoid circular import
...
async def handle_clear(webui_manager: Any): # Changed from WebuiManager to Any to avoid circular import
...
def create_browser_use_agent_tab(webui_manager: Any): # Changed from WebuiManager to Any to avoid circular import
    """
