...
def create_agent_settings_tab(webui_manager: Any):
    """
    ...
    with gr.Group():
        with gr.Row():
            ...
            llm_model_name = gr.Dropdown(
                ...
                choices=config.model_names["grok"],
                value=config.model_names["grok"][0],
                interactive=True,
        ...
        with gr.Row():
            ...
            llm_api_key = gr.Textbox(
                ...
                info="Paste your Groq API key here (required)",
