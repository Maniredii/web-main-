...
async def run_deep_research(webui_manager: Any, components: Dict[Component, Any]) -> AsyncGenerator[
...
async def stop_deep_research(webui_manager: Any) -> Dict[Component, Any]:
...
async def update_mcp_server(mcp_file: str, webui_manager: Any):
    """
...
def create_deep_research_agent_tab(webui_manager: Any):
    """
