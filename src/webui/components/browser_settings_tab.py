...
async def close_browser(webui_manager: str):
    """
    Close browser
    """
    ...
    if webui_manager_instance.bu_current_task and not webui_manager_instance.bu_current_task.done():
        webui_manager_instance.bu_current_task.cancel()
        webui_manager_instance.bu_current_task = None

    if webui_manager_instance.bu_browser_context:
        logger.info("⚠️ Closing browser context when changing browser config.")
        await webui_manager_instance.bu_browser_context.close()
        webui_manager_instance.bu_browser_context = None

    if webui_manager_instance.bu_browser:
        logger.info("⚠️ Closing browser when changing browser config.")
        await webui_manager_instance.bu_browser.close()
        webui_manager_instance.bu_browser = None

def create_browser_settings_tab(webui_manager: str):
    """
    ...
    webui_manager_instance.add_components("browser_settings", tab_components)
